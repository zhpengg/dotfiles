...
function! <SID>InsertHeadFormat()
  ...
  call append(line('$')-2, "#ifndef <PROJECT>_<MODULE>_". s. "")
  call append(line('$')-2, "#define <PROJECT>_<MODULE>_". s. "")
  call append(line('$')-2, "")
  call append(line('$')-2, "#endif  //<PROJECT>_<MODULE>_". s. "")
endfunction
